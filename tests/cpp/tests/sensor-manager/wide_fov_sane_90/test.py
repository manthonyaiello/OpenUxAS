...
with Server(bridge_cfg=bridge_cfg) as server:
    try:
        ...
        camera = Object(
            ...
            FieldOfViewMode=1,
            DiscreteHorizontalFieldOfViewList=[90.0],
            randomize=True
        )
        ...
        assert fp['WidthCenter'] > 0, f"WidthCenter={fp['WidthCenter']} should be positive for HFOV=90"
        print(f"HFOV=90: elev={fp['GimbalElevation']}  GSD={fp['AchievedGSD']:.4f}  WidthCenter={fp['WidthCenter']:.2f}")
        print("OK")
    finally:
        pass
